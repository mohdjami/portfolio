    ...
    <main className="mt-32">
      <TracingBeam>
        ...
        <section className="grid lg:grid-cols-2 mx-16 lg:mt-20 lg:gap-5">
          <div className="h-auto ml-6 w-full bg-transparent flex flex-col items-center justify-center overflow-hidden rounded-md">
          ...
          <div className="grid lg:h-auto w-full mb-10 bg-transparent  gap-10 lg:flex flex-col items-center justify-center overflow-hidden rounded-md ">
            <div className="relative w-[300px] h-[300px]">
              <div className="rounded-full p-1 bg-gradient-to-r from-black to-red-500">
                <Image
                  src="/linkedin-removebg-preview2.jpg"
                  alt="Mohd Jami"
                  width={500}
                  height={500}
        ...
        <section className="m-16 items-start grid ">
          <div className="text-xl text-center bg-transparent md:text-2xl lg:text-3xl font-bold border border-slate-800 text-neutral-700 dark:text-white max-w-7xl leading-relaxed lg:leading-snug my-20 py-6">
